...
- **Folder:** `worker/worker_contract/scripts`
...
## File Summaries
- `CONTEXTCHECK.md`:
  - Markdown documentation/report file maintained in `worker/worker_contract/scripts`.
  ...
  - Observed size is 548 bytes across 18 lines (14 non-empty lines).
