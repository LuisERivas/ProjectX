...
3. Run coarse-to-fine elbow selection over integer k-range.
   ...
   - Fine scan default targets `round(2% of candidate span)` values around the best coarse k.
   - Coarse ratio and fine-span ratio are implementation-tunable parameters.
